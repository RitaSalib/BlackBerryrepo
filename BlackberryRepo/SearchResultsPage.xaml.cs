...
namespace BlackberryRepo
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : BlackberryRepo.Common.LayoutAwarePage
    {
        string searchString;
    ...
    searchPane.SuggestionsRequested += searchPane_SuggestionsRequested;
        ...
        void Filter_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (selectedFilter != null)
            {
                ...
                this.DefaultViewModel["Results"] = App.MainViewModel.GetSearchResults(searchString);
                this.DefaultViewModel["ItemDetailsCommand"] = App.MainViewModel.ItemDetailsCommand;


                object results;
                IEnumerable<RepoItem> resultsCollection;

                if (this.DefaultViewModel.TryGetValue("Results", out results) &&
                    (resultsCollection = results as IEnumerable<RepoItem>) != null &&
        ...
        /// </summary>
        private sealed class Filter : BlackberryRepo.Common.BindableBase
        {
