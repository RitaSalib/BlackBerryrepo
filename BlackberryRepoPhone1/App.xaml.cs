        ...
        public static MainPageViewModel MainViewModel
        {
            get
            {
                if (mainViewModel == null)
                {
                    ...
                    INavigationService navigationService = new BlackberryRepoPhone1.Services.NavigationService();
                    mainViewModel = new MainPageViewModel(serializationService, fileService, navigationService, new GlobalizationService(),null,null);
                }
